...
(10, 2, 0, 2021, 'M4クーペ', 'BMW', 3000, 2021, 'M4クーペコンペティション', '3BA-52AZ30', 0, 4, 2, 'クーペ', 0, 3000, '8AT', 'FR', '2025-04-01', 0, 'S', '左', '灰M', 'C4P', 'グレー', 14217000, 'AAモータース', '☆★☆M4 Competition【ワンオーナー】【M Driveプロフェッショナル】【Mカーボンエクステリアパッケージ】【フルレザーインテリア】【オプション鍛造20インチAW】【Mカーボンバケットシート】☆★☆\r\n●harman/kardonサラウンド・サウンド・システム（464W、16スピーカー、9チャンネル・サラウンド）\r\n●カーボン・ファイバー強化樹脂（CFRP）製ルーフ\r\n', 'pictures/10');
